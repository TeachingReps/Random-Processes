...
\input{header}
\title{Lecture-09: Joint Distributions}
\author{}
...
\subsection{Probability Mass function of sum of jointly discrete random variables}
\subsection{Joint distribution and density}
\subsection{Marginal density}
%\section{Continuous Random Variables}
\subsection{Linearity of expectation}
\subsection{Conditional distribution and density}
\end{document}
