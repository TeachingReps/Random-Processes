...
\input{header}
\title{Lecture-07: Generalized Expectations}
\author{}

\begin{document}
\maketitle

\section{Generalization of Expectation Operator} 
\subsection{Expectation of functions of discrete random variables}
\subsection{Moments}
\subsubsection{Variance}
\subsubsection{$K$-th order moments} 
\subsubsection{Central moments}
\subsection{Linearity of expectation for discrete random variables}
