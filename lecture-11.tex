...
\input{header}
\title{Lecture-11: Characteristic Function}
\author{}

\begin{document}
\maketitle

\subsection{Relation between moments and characteristic function}
\subsection{Moment generating function}
\subsection{Probability generating function}
\subsection{Joint characteristic function and independence}
\subsection{Characteristic function of the Gaussian distribution}
\end{document}
